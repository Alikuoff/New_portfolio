    ...
    <footer className="bg-gray-800 text-white py-4 mt-10">
        <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="mt-4 flex flex-wrap justify-center space-x-4">
                <a href="https://www.facebook.com/#" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-gray-100">
                    <i className="fab fa-facebook-square mr-2 text-blue-500" aria-hidden="true">Facebook</i> 
                </a>
                <a href="https://www.instagram.com/#" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-gray-100">
                    <i className="fab fa-instagram mr-2 text-pink-500" aria-hidden="true">Instagram</i>
                </a>
                <a href="https://www.linkedin.com/in/#" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-gray-100">
                    <i className="fab fa-linkedin mr-2 text-blue-700" aria-hidden="true">LinkedIn</i> 
                </a>
                <a href="https://www.twitter.com/#" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-gray-100">
                    <i className="fab fa-twitter-square mr-2 text-blue-400" aria-hidden="true">Twitter</i> 
                </a>
                <a href="https://www.github.com/#" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-gray-100">
